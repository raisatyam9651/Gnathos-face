...
<head>
    ...
    <meta name="description"
        content="Gnathos provides advanced surgical care for face, mouth, and jaw, specializing in maxillofacial treatments to restore function and enhance appearance.">
    ...
    <div class="page-wraper">
        ...
        <main class="page-content">
            ...
            <div class="dz-bnr-inr dz-banner-dark  dz-bnr-inr-md"
                style="background-image:url(assets/images/about-us.webp);">
                <div class="container">
                    <div class="dz-bnr-inr-entry d-table-cell">
                        ...
                        <div class="dz-btn">
                            <a href="https://wa.me/919000666476"
                    ...
                    <div class="row content-wrapper style-1 align-items-center">
                        <div class="col-xl-6 m-b30">
                            <div class="content-media">
                                ...
                                <div class="item1" data-bottom-top="transform: translateY(-50px)"
                                    data-top-bottom="transform: translateY(50px)">
                                    <div class="info-widget style-7">
                                    </div>
                                </div>
                                <div class="item2" data-bottom-top="transform: translateY(50px)"
                                    data-top-bottom="transform: translateY(-50px)">
                        ...
                        <div class="col-xl-6 m-b30">
                            <div class="section-head style-1 m-b30">
                                <h2 class="title wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.8s">
                                    World-Class Facial Care at GNATHOS </h2>
                                <p class="wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">Experience the
                                    future of facial healthcare at GNATHOS. Our state-of-the-art facilities are designed
                                    with the latest technology to ensure you receive the highest quality care. Here,
                                    advanced tools combine with unmatched expertise, offering a comfortable and
                                    effective path to improved facial health and function.</p>
                            </div>
                            ...
                            <div class="d-flex flex-wrap align-items-center wow fadeInUp" data-wow-delay="0.8s"
                                data-wow-duration="0.8s">
                                <a href="https://wa.me/919000666476"
                                    class="btn btn-lg btn-icon btn-secondary btn-shadow m-r30 mb-3 mb-sm-0">
                                    Appointment
            ...
            <section class="vmv">
                ...
                <div class="container">
                    <header class="vmv__header">
                        ...
                        <p class="vmv__subtitle">Advancing Facial Healthcare Through Expertise, Innovation, and
                    ...
                    <div class="vmv__grid">
                        ...
                        <div class="vmv__card">
                            ...
                            <div class="vmv__card-body">
                                <p class="vmv__description">
                                    To be the leading center of excellence in facial reconstruction and rehabilitation,
                                    setting new standards in patient care and surgical innovation.
                                </p>
                                <ul class="vmv__list">
                                    <li class="vmv__item">
                        ...
                        <div class="vmv__card">
                            ...
                            <div class="vmv__card-body">
                                <p class="vmv__description">
                                    To provide comprehensive, advanced care for all facial concerns while ensuring
                                    optimal functional and aesthetic outcomes for every patient.
                                </p>
                                <ul class="vmv__list">
                                    <li class="vmv__item">
                                        <span class="vmv__item-icon">
                        ...
                        <div class="vmv__card">
                            ...
                            <div class="vmv__card-body">
                                <p class="vmv__description">
                                    We uphold the highest standards of medical ethics, professional integrity, and
                ...
                <div class="container">
                    <div class="row content-wrapper style-7 align-items-center">
                        ...
                        <div class="col-lg-6 m-b30">
                            <div class="section-head style-1 m-b30">
                                <h2 class="title text-white m-b0 wow fadeInUp" data-wow-delay="0.2s"
                                    data-wow-duration="0.7s">Excellence in Facial Care </h2>
                            </div>
                            <div class="row row-wrapper g-5">
                                <div class="col-sm-6">
                                    <div class="icon-bx-wraper style-4 text-center text-white wow fadeInUp"
                                ...
                                <div class="col-sm-6">
                                    <div class="icon-bx-wraper style-4 text-center text-white wow fadeInUp"
                                        ...
                                        <div class="icon-content">
                                            ...
                                            <p>Our expert team is here to provide personalized solutions, addressing
                                                your specific facial health concerns with precision and care.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="icon-bx-wraper style-4 text-center text-white wow fadeInUp"
                                        ...
                                        <div class="icon-content">
                                            ...
                                            <p>From consultation to recovery, we provide complete facial care under one
                                                roof, using the latest technology for a smooth and stress-free
                                                experience.</p>
                                ...
                                <div class="col-sm-6">
                                    <div class="icon-bx-wraper style-4 text-center text-white wow fadeInUp"
                                        ...
                                        <div class="icon-content">
                                            ...
                                            <p>Our skilled maxillofacial surgeons use advanced techniques to restore
                                                facial health, function, and aesthetics with precision.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="clearfix p-t50 pb-5   overflow-hidden"
                style="background:linear-gradient(135deg, var(--pale-blue) 100%, #F8FBFF 0%);; background-repeat: no-repeat; background-position: right center; background-size: cover;">
                <div class="container">
                    <div class="row content-wrapper style-2">
                        <div class="col-xl-6">
                            <div class="content-media">
                                ...
                                <div class="circle-wrapper" data-bottom-top="transform: translateY(50px)"
                                    data-top-bottom="transform: translateY(-50px)">
                                    <span class="circle1">
                                        <span></span>
                                        <span></span>
                                ...
                                <div class="item1" data-bottom-top="transform: translateY(50px)"
                                    ...
                                    <div class="info-widget style-1 move-3">
                                        <div class="avatar-group">
                                            <img class="avatar rounded-circle avatar-sm border border-white border-2"
                                                src="images/avatar/small/Avtar-mail.png" alt="">
                                            <img class="avatar rounded-circle avatar-sm border border-white border-2"
                                                src="images/avatar/small/Avter-mail.png" alt="">
                                            <img class="avatar rounded-circle avatar-sm border border-white border-2"
                                                src="images/avatar/small/Avtar-mail.png" alt="">
                                            <img class="avatar rounded-circle avatar-sm border border-white border-2"
                                                src="images/avatar/small/Avter-mail.png" alt="">
                        ...
                        <div class="col-xl-6 col-lg-10 align-self-center m-b30">
                            ...
                            <div class="swiper-btn-center-lr wow fadeInUp" data-wow-delay="0.4s"
                                data-wow-duration="0.7s">
                                            ...
                                            <div class="testimonial-1 shadow-md">
                                                ...
                                                <div class="testimonial-detail">
                                                    <div class="testimonial-text">
                                                        ...
                                                        <p>"I had surgery at GNATHOS, and I couldn’t be happier with the
                                                            results. The care I received was exceptional, and I felt
                                                            supported throughout the entire process. Highly recommend!"
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="testimonial-1 shadow-md">
                                                ...
                                                <div class="testimonial-detail">
                                                    <div class="testimonial-text">
                                                        ...
                                                        <p>"Dr. Navatha made my treatment journey smooth and reassuring.
                                                            She took the time to explain everything and was with me
                                                            every step of the way. I’m incredibly grateful for her care
                                                            and expertise."</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="testimonial-1 shadow-md">
                                                ...
                                                <div class="testimonial-detail">
                                                    <div class="testimonial-text">
                                                        ...
                                                        <p>"My experience at GNATHOS was outstanding. Dr. Suresh and the
                                                            team made sure I was comfortable and confident during my
                                                            treatment. Their professionalism and skill are unmatched."
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
